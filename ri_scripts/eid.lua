...
local ItemDescriptionsEnglish = {
    ...
    [CollectibleType.COLLECTIBLE_DUALITY] = "{{AngelDevilChance}} Spawns a oscillating Devil and Angel room if either would have spawned#Entering one makes the other one unenterable",
